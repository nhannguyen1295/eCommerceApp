...
namespace eCommerceApp.Server.Migrations
{
    ...
    [Migration("20210131110830_ImproveForProductDetails")]
    partial class ImproveForProductDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "deabca75-bb62-4a07-bd14-38064794df06",
                            ConcurrencyStamp = "8508fa55-ca8c-49e8-aa5c-3645cb07a3e2",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "9625fd3a-9355-4090-be76-fcab6224fc95",
                            ConcurrencyStamp = "b0439d7f-9b72-4d73-a886-e47ab98c389d",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "55585c99-bec8-4757-b514-4641d856d905",
                            ConcurrencyStamp = "bdf8cc7f-a35d-4bc4-82a3-0ccf2177012b",
                            Name = "NormalUser",
            ...
            modelBuilder.Entity("eCommerceApp.Entities.Models.Attribute", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eCommerceApp.Entities.Models.AttributeValue", b =>
                {
                    ...
                    b.HasKey("AttributeId", "ProductAttributeValueId");
            ...
            modelBuilder.Entity("eCommerceApp.Entities.Models.CategoryAttributeValue", b =>
                {
                    ...
                    b.HasKey("CategoryId", "AttributeValueId");
            ...
            modelBuilder.Entity("eCommerceApp.Entities.Models.ProductAttributeValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eCommerceApp.Entities.Models.ProductMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eCommerceApp.Entities.Models.AttributeValue", b =>
                {
                    b.HasOne("eCommerceApp.Entities.Models.Attribute", "Attribute")
                        .WithMany("AttributeValues")
                        .HasForeignKey("AttributeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eCommerceApp.Entities.Models.ProductAttributeValue", "ProductAttributeValue")
                        .WithMany("AttributeValues")
            ...
            modelBuilder.Entity("eCommerceApp.Entities.Models.CategoryAttributeValue", b =>
                {
                    b.HasOne("eCommerceApp.Entities.Models.AttributeValue", "AttributeValue")
